...
const LiveChat = () => {
  ...
  return (
    ...
    <div className="w-full"><input value={message} onChange={(e) => setMessage(e.target.value)} placeholder="type something..." className="w-full border border-blue-600 bg-transparent p-2 outline-none"></input></div>
    </div>
  );
};
